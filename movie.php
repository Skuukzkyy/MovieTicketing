...
<body>
  ...
  <div class="container">
  <?php
      $rows = mysqli_query($conn, "SELECT * FROM movie_tbl WHERE movie_start BETWEEN '$current_date' AND '$next_month_date'");
      foreach ($rows as $row): $id = $row['movie_id']?>
        <div class="box"></a>
          <div class="imgBox">
            <img src="img/<?php echo $row['banner2'] ?>">
  ...
  <div class="container">
    <?php
      $rows = mysqli_query($conn, "SELECT * FROM movie_tbl ORDER BY movie_title LIMIT 10");
      foreach ($rows as $row): $id = $row['movie_id']?>
        <div class="box"></a>
          <div class="imgBox">
            <img src="img/<?php echo $row['banner2'] ?>">
